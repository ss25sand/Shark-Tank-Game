# Saman Sandhu
# June 18, 2018
# SharkTankGPIOGame.py
# my summative project (game using raspberry pi)
...
def Lives():
    ...
    while not pause:
        ...
        # check down button input data pin
        continueButton = GPIO.input(18)
        # if pressed
        if continueButton == 1:
            game_loop()
...
def button(msg,x,y,width,height,iC,aC,action=None):
    ...
    # set mouse position and click variables
...
def unpause():
    ...
    while 0 < sec < 4:
        ...
        # decrease seconds
        sec -= 1
        # increase x position of text
        x += 75
        pygame.display.update()

# Shark -- Score Function
def Shark_dodge(count):
    # set and display number of sharks dodged
...
def Whale_dodge(count):
    # set and display number of whales dodged
    font = pygame.font.SysFont(None, 25)
...
def NumberOfRockets(count):
    # set and display number of rockets available
    font = pygame.font.SysFont(None, 25)
...
# distance travelled
def distance():
    # increase player distance
    Player.distance += 1
    # set and display distance
    font = pygame.font.SysFont(None, 25)
...
def game_loop():
    ...
    while running:
        ...
        # check down button input data pin  
        downButton = GPIO.input(14)
        # if button is pressed
        if downButton == 1:
            moveY = 10

        # check down button input data pin
        upButton = GPIO.input(15)
            
        if upButton == 1:
            moveY = -10

        # check down button input data pin
        endButton = GPIO.input(23)
        # if button is pressed  
        if endButton == 1:
            pause = False
            paused()
        ...
        # check down button input data pin
        rocketButton = GPIO.input(24)
        # if button is pressed       
        if rocketButton == 1:
            print("Pressed: 24")
            if Bullet.numbBullet > 0:
